...
import gppLibrary.connectors.reducers.ListParOne
...
class JUtest25Log {
    ...
    public void test() {
        ...
        def logVis = new LoggingVisualiser( logInput: logChan.in(),
                collectors: 1,
                logFileName: "D:\\IJGradle\\gppLibrary\\src\\test\\groovy\\gppJunitTests\\LogFiles/25")
        ...
        def inFan = new ListParOne( inputList: inCollectList,
        output: chan2.out())
