...
class JUtest19 {
    ...
    public void test() {
        ...
        def rscl1 = new RequestingSeqCastList(outRequestAny: request.out(),
        inResponseAny: response.in(),
        outputList: outList1 )

        def rscl2 = new RequestingSeqCastList(outRequestAny: request.out(),
        inResponseAny: response.in(),
        outputList: outList2 )
        ...
        PAR testParallel = new PAR([emitter, ofra, rscl1, rscl2, afo, collector]+ g1 + g2)
        testParallel.run()
