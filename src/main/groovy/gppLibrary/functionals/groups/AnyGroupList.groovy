...
//mimport gppLibrary.functionals.workers.Worker
/**
 *
 ...
 * @param gDetails A {@link gppLibrary.GroupDetails} object defining any local class of each worker, default to null
...
//			gpp.DataClass.unexpectedReturnCode("AnyGroupList: Number of workers mismatch, Process exepcted $workers, Details specified ${gDetails.workers}", -1)
