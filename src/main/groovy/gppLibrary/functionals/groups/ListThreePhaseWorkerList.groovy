...
/**
 * The ListThreePhaseWorkerList process implements a group of {@link gppLibrary.functionals.workers.ThreePhaseWorker} connected
 ...
 * @param lDetails specifies the {@link gppLibrary.LocalDetails} object describing the local worker class used by
