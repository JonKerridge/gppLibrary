...
/**
 *
 * MultiCoreEngine creates a process network comprising a {@link gppLibrary.functionals.matrix.MultiCoreRoot} together with a
 * number of {@link gppLibrary.functionals.matrix.MultiCoreNode} processes. The goal of the complete process
