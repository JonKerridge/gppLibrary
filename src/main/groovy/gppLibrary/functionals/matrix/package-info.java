/**
 * Package gpp.functionals.matrix provides a number of matrix based processing engines. Two basic objects are
 ...
 * that object, possibly to another ImageEngine process.<br>
