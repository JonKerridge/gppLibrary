 ...
 * in the writing of a feedback object to an {@link gppLibrary.terminals.EmitWithFeedback} process
 * 
 * <p>
 ...
 * @param fDetails A {@link gppLibrary.FeedbackDetails} object that specifies the feedback Object and the evaluation function
* <p>
 *
*/


class FeedbackObject extends DataClass implements CSProcess {
