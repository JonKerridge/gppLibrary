package gppLibrary.functionals.pipelines
 ...
 * @param pDetails A {@link gppLibrary.PipelineDetails} object defining any local class of each stage, default to null
 * @param rDetails A {@link gppLibrary.ResultDetails} object defining the result class used by the Collect process
