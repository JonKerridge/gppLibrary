 ...
 * is used from the package {@link gppLibrary.functionals.transformers.FeedbackSensor} This
 ...
 * to evaluate whether feedback is required, called in the FeedbackSensor.
 ...
 * The input object will be written to the FeedbackSensor output channel.
 * The fbObject will be written to the FeedbackSensor feedback channel.
 */
