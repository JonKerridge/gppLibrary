 ...
 * LoggingVisualiser is a JCSP process which recieves logging events from other processes, appends the event to a log
 * and communicates the nature of the event to the Visualier so the visual network can display the event.
 */
